...
@section('nav_active_persetujuan_list', 'active')
@section('content')
            ...
            <div class="card" id="orderList">
                <div class="card-header  border-0">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title mb-0 flex-grow-1">List Persetujuan</h5>
                ...
                <div class="card-body border border-dashed border-end-0 border-start-0">
                    <form>
                        <div class="row g-3">
                            ...
                            <!--end col-->
                            {{-- <div class="col-xxl-3 col-sm-3"> --}}
                                {{-- <select class="form-control" data-choices name="nik">
                                    <option value="">Filter berdasarkan status</option>
                                    <option value="1">Filter berdasarkan status 1</option>
                                    <option value="2">Filter berdasarkan status 2</option>
                            ...
                            <table class="table table-nowrap align-middle" id="orderTable">
                                <thead class="text-muted table-light">
                                    <tr class="text-uppercase">
                                        ...
                                        <th class="sort desc" data-sort="id">Branch</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-top">
                                                ...
                                                @elseif($hist->status == 6)
                                                    <span class="badge badge-soft-success badge-border text-wrap">
