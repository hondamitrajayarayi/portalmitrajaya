  ...
  <head>
    ...
    <style>
      ...
      .button {
        ...
        .button1 {background-color: #43a146;} 
          ...
          <div class="content">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr
                                    ...
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        Permintaan RB baru {{ $details['rb_id'] }} telah selesai disetujui management,
                                ...
                                <tr
                                    ...
                                    <td class="content-block"
                                        ...
                                        <table class="table table-striped fs-13">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="pt-2 pb-2" width="150px" style="font-weight: 600;">Nama Pemohon</td>
                                                    <td class="pt-2 pb-2" width="10px">:</td>
                                                    <td class="pt-2 pb-2">{{ $details['pemohon'] }}</td>
                                                </tr>
                                                @if(!empty($details['mengetahui']))
                                                <tr>
                                                    <td class="pt-2 pb-2" width="150px" style="font-weight: 600;">Mengetahui</td>
                                                    <td class="pt-2 pb-2" width="10px">:</td>
                                                    <td class="pt-2 pb-2">{{ $details['mengetahui'] }} ({{ $details['j_mengetahui'] }})</td>
                                                </tr>
                                                @endif
                                                <tr>
                                                    <td class="pt-2 pb-2" style="font-weight: 600;">Cabang</td>
                                                    <td class="pt-2 pb-2">:</td>
                                                    <td class="pt-2 pb-2">{{ $details['cabang'] }}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                  <td style="font-family: 'Roboto', sans-serif; color: #878a99; box-sizing: border-box; line-height: 1.5; font-size: 15px; vertical-align: top; margin: 0; padding: 0 0 10px;">
                                    Detail rekening dapat dilihat setelah melakukan login. Anda dapat login di :</td>
                                </tr>
                                <tr>
                                ...
                                <tr
                                    style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; border-top: 0px solid #e9ebec;">
                                    <td class="content-block"
                                        ...
                                        <div style="display: flex; align-items: center;">
                                          ...
                                          <div style="margin-left: 8px;">
                                            <span style="font-weight: 600;">Salam Hangat
                                            </span>
                                            <p
            ...
            <div class="footer">
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    Ini adalah email yang dibuat secara otomatis, mohon tidak untuk dibalas.
                  </td>
                </tr>
                <tr>
                  <td class="content-block">
