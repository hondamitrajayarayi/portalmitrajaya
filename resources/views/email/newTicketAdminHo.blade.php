                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr
                                    ...
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        Permintaan RB baru {{ $details['rb_id'] }} telah diterima,
                                        harap untuk ditindak lanjuti.
                                    </td>
                                </tr>
                                <tr
                                    style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                ...
                                <tr>
                                  <td style="font-family: 'Roboto', sans-serif; color: #878a99; box-sizing: border-box; line-height: 1.5; font-size: 15px; vertical-align: top; margin: 0; padding: 0 0 10px;">Harap setujui setelah login.
                                    Anda dapat login di :</td>
                                </tr>
                                <tr>
