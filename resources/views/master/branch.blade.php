...
@section('nav_active_branch', 'active')
                    ...
                    <div class="row g-4" data-v-cd5f1dea="">
                        <div class="col-12 col-md-6" data-v-cd5f1dea="">
                            ...
                            <div class="d-flex justify-content-md-start justify-content-center" data-v-cd5f1dea=""
                                ...
                                <h6 class="card-title mb-0 mt-2 font-poppins" >Master Branch</h6>
                                {{-- </a> --}}
                            </div>
                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="sort" data-sort="status">Branch Id</th>
                                    <th class="sort" data-sort="status">Schema</th>
                            ...
                            <tbody class="list form-check-all" id="carirow">
                                @foreach ($data as $no => $item)
                                    <tr>
                                        ...
                                        <td class="customer_name">{{ $item->branch_id }}</td>
                                        <td class="customer_name">{{ $item->schema_name }}</td>
                                        <td class="customer_name">{{ $item->branch_name }}</td>
                ...
                <div class="card-body" >
                    <div class="list-setting" >
                        ...
                        <div class="d-flex mb-2 list-setting_item pointer" >
                            <div class="flex-shrink-0" ><span
                                    class="badge badge-soft-primary p-1 fs-15" ><i
                                        class="text-info ri-building-line" ></i></span></div>
                            <div class="flex-grow-1 ms-2 mt-0 mt-1 overflow-hidden" ><a
