...
@section('nav_active_jabatan', 'active')
...
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content border-0">
                <div class="modal-header p-3 bg-primary" data-v-01bddeea="">
                    <h5 class="modal-title text-light" id="exampleModalLabel" data-v-01bddeea=""> Tambah Jabatan </h5>
                            ...
                            <div class="col-xxl-12">
                                <div>
                                    <label for="validationCustom02"
                                        class="form-label @error('nama_jabatan') text-danger @enderror">Nama Jabatan</label>
                                        <input type="text" name="nama_jabatan" 
                                        class="form-control @error('nama_jabatan') is-invalid @enderror" id="validationCustom04"
                                        autocomplete="off">
    ...
    <div class="modal fade zoomIn" id="modaledit" tabindex="-1" aria-labelledby="exampleModalgridLabel" data-v-01bddeea=""
        ...
        <div class="modal-dialog">
            <div class="modal-content border-0">
                <div class="modal-header p-3 bg-primary" data-v-01bddeea="">
                    <h5 class="modal-title text-light" id="exampleModalgridLabel">Edit Jabatan</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"
                        id="close-modal" data-v-01bddeea=""></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('jabatan.update') }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-xxl-12">
                                <div>
                                    <label for="validationCustom02"
                                        class="form-label @error('edit_nama') text-danger @enderror">Nama Jabatan</label>
        ...
        <div class="col-xl-9">
            <div div class="card">
                <div class="card-header" >
                    <h6 class="card-title mb-0 font-poppins fs-15" >Master Jabatan</h6>
                </div>
                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="sort" data-sort="email">Nama Jabatan</th>
                            ...
                            <tbody class="list form-check-all" id="carirow">
                                @foreach ($data as $no => $item)
                                    <tr>
                                        ...
                                        <td class="customer_name">{{ $item->nama_jabatan }}</td>
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" data-v-cd5f1dea=""
                                                        ...
                                                        <li data-v-cd5f1dea="">
                                                            <a class="dropdown-item remove-item-btn confirm-delete"
                                                                ...
                                                                Delete
                                                                <form method="POST"
                                                                    action="{{ route('jabatan.hapus', $item->id) }}"
                                                                    id="delete-{{ $item->id }}">
                                                                    @csrf
                                                                    @method('delete')
                                                                </form>
                ...
                <div class="card-body" >
                    <div class="list-setting" >
                        ...
                        <div class="d-flex mb-2 list-setting_item pointer" >
                            <div class="flex-shrink-0" ><span
                                    class="badge badge-soft-primary p-1 fs-15" ><i
                                        class=" text-info ri-hand-coin-line" ></i></span></div>
                            <div class="flex-grow-1 ms-2 mt-0 mt-1 overflow-hidden" ><a
    ...
    <script>
        $(document).on('click', '.edit', function() {
            ...
            $.get(url + id + '/edit', function(data) {
                ...
                console.log(data);
                $('#id').val(data.id);
                $('#edit_nama').val(data.nama_jabatan);
