...
@section('title', 'Master Jenis Inventaris')
@section('nav_active_jenis_inventaris', 'active')
                    ...
                    <div class="row g-4" data-v-cd5f1dea="">
                        <div class="col-12 col-md-6" data-v-cd5f1dea="">
                            ...
                            <div class="d-flex justify-content-md-start justify-content-center" data-v-cd5f1dea=""
                                ...
                                <h6 class="card-title mb-0 mt-2 font-poppins" >Master Jenis Inventaris</h6>
                                {{-- </a> --}}
                            </div>
                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="sort" data-sort="status">Nama Jenis</th>
                            ...
                            <tbody class="list form-check-all" id="carirow">
                                @foreach ($data as $no => $item)
                                    <tr>
                                        ...
                                        <td class="customer_name">{{ $item->nama_jenis }}</td>
                                        <td class="customer_name">{{ $item->group->group_name }}</td>
